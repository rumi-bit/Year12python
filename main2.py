...
class AppWindow:
    def __init__(self, logic_ref):
        ...
        self.buttons = {
            "pickup": {"rect": SDL_Rect(425, 500, 350, 50 ), "text":"Pickup", "font":self.font_main},
        }
        ...
        self.nextbutton = SDL_Rect(200, 500, 400, 50)
    ...
    def details(self):
        ...
        roundedBoxRGBA(self.renderer, self.nextbutton.x, self.nextbutton.y, self.nextbutton.x + self.nextbutton.w, self.nextbutton.y + self.nextbutton.h, 12, 255, 0, 0, 255)
